...
var _initNav = require("./modules/nav/init-nav");
var _searchValidate = require("./modules/form-validate/search-validate");
// ---------------------------------

window.addEventListener('DOMContentLoaded', function () {
  (0, _initNav.initNav)();
  (0, _searchValidate.searchValidate)();
  // Utils
  // ---------------------------------
...
},{"./modules/form-validate/form":3,"./modules/form-validate/search-validate":8,"./modules/modals/init-modals":10,"./modules/nav/init-nav":12,"./utils/ios-vh-fix":15}],2:[function(require,module,exports){
"use strict";
...
},{"./callback":2,"./init-phone-input":4,"./validator":9}],4:[function(require,module,exports){
"use strict";
...
exports.searchValidate = void 0;
var searchValidate = exports.searchValidate = function searchValidate() {
  var searchInput = document.querySelector('.intro__search');
  var SEARCH_VALID_REGEX = /[!@#$%^&*()]/;
  var onInputRegex = function onInputRegex() {
    var value = searchInput.value.toLowerCase();
    if (SEARCH_VALID_REGEX.test(value) || searchInput.value.length > 12) {
      searchInput.setCustomValidity("\u041C\u0430\u043A\u0441\u0438\u043C\u0430\u043B\u044C\u043D\u0430\u044F \u0434\u043B\u0438\u043D\u0430 \u0437\u0430\u043F\u0440\u043E\u0441\u0430 12 \u0441\u0438\u043C\u0432\u043E\u043B\u043E\u0432.\n          \u0417\u0430\u043F\u0440\u043E\u0441 \u0434\u043E\u043B\u0436\u0435\u043D \u0441\u043E\u0441\u0442\u043E\u044F\u0442\u044C \u0438\u0437 \u0431\u0443\u043A\u0432 \u0438 \u0447\u0438\u0441\u0435\u043B \u0438 \u043D\u0435 \u043C\u043E\u0436\u0435\u0442 \u0441\u043E\u0434\u0435\u0440\u0436\u0430\u0442\u044C \u0441\u043F\u0435\u0446\u0441\u0438\u043C\u0432\u043E\u043B\u044B (!,@,#,$,%,^,&,*,()).");
    } else {
...
},{"./matrix":5,"./regular-expression":6,"./render-message":7}],10:[function(require,module,exports){
"use strict";
...
var _focusLock = require("../../utils/focus-lock");
var initNav = exports.initNav = function initNav() {
  ...
  var focus = new _focusLock.FocusLock();
...
},{"../../utils/focus-lock":13}],13:[function(require,module,exports){
"use strict";
